...
function [G1,S,G2,M,p1,p2,p3]=process_protein_averages()
    ...
    for i = 1:num_files
        ...
        all_cell_levels=[all_cell_levels;cell_levels];
    ...
    avg_cell_level=mean(all_cell_levels,1)
    frac_cell_level=avg_cell_level/sum(avg_cell_level)
    ...
    figure;
    plot(x_values,frac_cell_level,'o-','LineWidth', 2, 'MarkerSize', 8, 'Color', 'r');
