...
if __name__=='__main__':
    ...
    #path='./data/NKL_greg/Ly49h/Ly49H_'
    path='./data/NKL_greg/Ly49h/biaxial_M/Ly49H_'  #The M phase is collected from the biaxial plot and not the UMAP
    ...
    df_test_idx.to_csv('Ly49h_colormap_logtransformed_feb8_25_G2_M_combined_M_biaxial.csv', index=False) #skip the previous file and look at the file now

 
    # Specify the protein name you are interested in
    #protein_name = b'CD16'
    protein_name = b'pStat5'
