...
if __name__=='__main__':
    ...
    path='./data/NKLs/ly49h_umap/Ly49H_'
    ...
    test_idx = write_class_file(a,b,c,name_list)#something wrong with the file printing here
    ...
    df_test_idx.to_csv('Ly49H_colormap_logtransformed_Sept25.csv', index=False) #skip the previous file and look at the file now


    
    # Specify the protein name you are interested in
    #protein_name = b'CD16'
    protein_name = b'pVav1'
